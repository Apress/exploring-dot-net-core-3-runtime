...
namespace RVJ.Core {
	public class DynamicBuilder : IDynamicBuilder {
		...
		TypeBuilder GetPersonInterface( ModuleBuilder module ) {

			TypeBuilder personInterfaceBuilder = module.DefineType( "RVJ.Core.IPerson", TypeAttributes.Public | TypeAttributes.Interface | TypeAttributes.Abstract );



			personInterfaceBuilder.DefineProperty( "Id", PropertyAttributes.HasDefault, typeof( System.UInt32 ), new Type[] { } );


			return personInterfaceBuilder;
		}
